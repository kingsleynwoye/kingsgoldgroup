    ...
    <>
      ...
      >
        ...
        <h1 className="text-4xl font-black tracking-tight md:text-7xl lg:text-8xl">
          ...
          <span className="text-[#151716]">GROUP</span>
        </h1>

        <h2 className="text-3xl md:text-5xl font-bold tracking-tight mt-5">
        ...
        <section className="mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-6 py-24 text-center">
          ...
          <p className="mt-8 max-w-3xl text-lg leading-8 text-zinc-600 md:text-xl">
            ...
            building innovative companies across multiple industries through
